...
public class FtpUtil {
    ...
    public void uploadFile(String file, String path) throws FileNotFoundException, JSchException, SftpException {
        uploadFile(new File(file), path);
    }

    public void uploadFile(File file, String path) throws JSchException, FileNotFoundException, SftpException {
        ...
        if (file.exists() && file.isFile()) {
            ...
            logger.warn("upload file {} to {} success", file.getAbsoluteFile(), destination);
        } else {
